...
public final class ActivityClaimBinding implements ViewBinding {
  ...
  private ActivityClaimBinding(@NonNull LinearLayout rootView, @NonNull TextView backButton,
      @NonNull TextView claimButton) {
  ...
  public static ActivityClaimBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityClaimBinding((LinearLayout) rootView, backButton, claimButton);
    }
